const frJSON = {
  ...
  'MI TUTORA NextJS Typescript Admin Dashboard':
    "Tableau de bord d'administration de MI TUTORA React",
  ...
  'Some of the features that make MI TUTORA one of the best admin templates available today':
    "Certaines des fonctionnalités qui font de MI TUTORA l'un des meilleurs modèles d'administration disponibles aujourd'hui",
