import { Box, Typography ,Button, Dialog, DialogContent,Grid
  , InputLabel, Select,
  MenuItem,FormControl,Slide, Alert} from '@mui/material';
  ...
  import { Legend1 } from 'src/utils/assets';
    ...
    return (
      <>
        ...
        <Grid item xs={3} style={{textAlign:'center', background:'white'}}>
          ...
          <Grid container xs={11} marginTop={2}>
          <img alt='foto' src={Legend1} width="90%"/>
          </Grid>
        </Grid>
        </Grid>
