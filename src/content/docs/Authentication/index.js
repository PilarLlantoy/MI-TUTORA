...
function HeaderUserbox() {
  ...
  return (
    <>
      <Helmet>
        <title>Authentication - MI TUTORA White React Javascript Admin Dashboard</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              MI TUTORA White React Javascript Admin Dashboard includes four separate
            ...
            <Typography paragraph>
              ...
              default, MI TUTORA White React Javascript Admin Dashboard comes with JWT Web
              Tokens enabled.
            </Typography>
            <Typography paragraph>
