...
function Dependencies() {
  return (
    <>
      <Helmet>
        <title>Dependencies - MI TUTORA White React Javascript Admin Dashboard</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              At it's core, MI TUTORA White React Javascript Admin Dashboard is powered by{' '}
              <code>React</code>, <code>@emotion/react</code> and{' '}
            ...
            <List>
              ...
              <Divider component="li" />
              <ListItem>
                <ListItemText primary="react-router" secondary="6.0.0-beta.0" />
              </ListItem>
              <Divider component="li" />
              <ListItem>
                <ListItemText
                  primary="react-router-dom"
                  secondary="6.0.0-beta.0"
                />
              </ListItem>
              <Divider component="li" />
              <ListItem>
                <ListItemText primary="react-scripts" secondary="4.0.3" />
              </ListItem>
            </List>
            <br />
            <Typography
            ...
            <Typography paragraph>
              ...
              Based on the pages/sections you'll be using from the MI TUTORA React
