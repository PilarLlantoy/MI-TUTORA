...
mock.onGet('/api/crypto-orders').reply(() => {
  ...
  return (
    <>
      <Helmet>
        <title>Server Requests - MI TUTORA White React Javascript Admin Dashboard</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Throughout MI TUTORA White React Javascript Admin Dashboard you will find a
