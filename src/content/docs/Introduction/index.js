...
function Introduction() {
  return (
    <>
      <Helmet>
        <title>Introduction - MI TUTORA White React Javascript Admin Dashboard</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            ...
            <Typography paragraph>
              MI TUTORA White React Javascript Admin Dashboard includes multiple pages
            ...
            <Typography paragraph>
              MI TUTORA White React Javascript Admin Dashboard is based on{' '}
