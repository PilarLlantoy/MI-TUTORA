...
function Changelog() {
  return (
    <>
      <Helmet>
        <title>Changelog - MI TUTORA White React Javascript Admin Dashboard</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            ...
            <List>
              ...
              <ListItem>
                Updated to react-router version 6 and improved the router.js
          ...
          <Grid item xs={12}>
            ...
            <List>
              <ListItem>
                ...
                <code>src\content\management\Users\single\SecurityTab.js</code>
              </ListItem>
              <ListItem>
