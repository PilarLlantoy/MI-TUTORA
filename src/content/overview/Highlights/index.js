    ...
    <BoxHighlights>
        ...
        <BoxLayoutsContent maxWidth="lg">
          ...
          >
            <Grid item xs={12} md={6}>
              ...
              >
                {t(
                  "Version 3.0 represents our biggest MI TUTORA update. We've added a brand new layout with 100% reworked and improved components. Check out the live preview to see them in action."
                )}
              </TypographySubHeading>
            </Grid>
            <Grid item xs={12} md={6}>
      ...
      >
        ...
        >
          ...
          <Grid item xs={12} md={6}>
            <Box>
              ...
              >
                {t(
                  'With MI TUTORA you can build apps for any purpose, from commerce to health or learning. We’ve got you covered!'
                )}
              </TypographySubHeading>
            </Box>
          </Grid>
        ...
        >
          <Grid item md={4}>
            <Box>
              ...
              >
                {t(
                  'MI TUTORA comes integrated with 13 dashboards split across multiple popular product niches'
                )}
                :
              </TypographySubHeading>
        ...
        <Container maxWidth="sm">
          ...
          >
            {t(
              'Some of the features that make MI TUTORA one of the best admin templates available today'
            )}
          </TypographyH2>
        </Container>
          ...
          >
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="subtitle2">
                {t(
                  "We've built MI TUTORA using modern industry standards all packed under MUI (Material-UI) components"
                )}
                .
              </Typography>
              <List
              ...
              >
                ...
                <ListItem>
                  ...
                  <ListItemText
                    primary={t(
                      'Progressive Web App Optimized. You can view MI TUTORA offline on any screen size.'
                    )}
                  />
                </ListItem>
                <ListItem>
      ...
      >
        ...
        >
          ...
          <Button
            ...
            target="_blank"
            size="large"
            href="https://www.figma.com/file/XVw1wWOvmpn3UljELShZi3/MI TUTORA-Admin-Dashboard"
            rel="noopener"
            variant="outlined"
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {t(
                      'Besid Figma files, MI TUTORA also has included Sketch design files for certain pricing plans.'
                    )}
                  </Typography>
                </Box>
              </Box>
