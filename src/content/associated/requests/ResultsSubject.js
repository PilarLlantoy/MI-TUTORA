...
const ResultsSubject = (props) => {
  ...
  const [requestClassGrades, setRequestClassGrades] = useState([]);
  const [requestDate, setRequestDate] = useState("");
  const [requestId, setRequestId] = useState(0);
  const [requestType] = useState("Solicitud de Selección de Tema");
    ...
    try {
      ...
      if (isMountedRef.current) {
        if (response.data.length === 0) {
          ...
          setRequestCategory(response.data.classCategoryName);
          setRequestSubject(response.data.classSubjectName);
          setRequestDescription(response.data.description);
          setRequestClassGrades(response.data.classGradeNames);
                            ...
                            <DialogContentText>
                              ...
                              >
                                ...
                                <Typography
                                  ...
                                  py="0.3rem"
                                >
                                  <b>Tipo de Solicitud:</b> {formatNameCapitals(requestType)}
                                </Typography>
                                <Typography
                                  variant="body1"
                                  fontSize="0.9rem"
                                ...
                                <Typography
                                  ...
                                  color="#223354"
                                >
                                  <b>Categoría:</b> {formatNameCapitals(requestCategory)}
                                </Typography>
                                <Typography
                                  variant="body1"
                                  fontSize="0.9rem"
                                ...
                                <Typography
                                  ...
                                  color="#223354"
                                >
                                  <b>Descripción:</b> {requestDescription}
                                </Typography>
                              </Grid>
                              <Grid
                                container
                              ...
                              >
                                <Typography
                                  ...
                                  color="#223354"
                                >
                                  <b>Grados Contemplados:</b>
                                </Typography>
                                <TextField
                                  disabled
                                  sx={{ width: '100%' }}
                                  id="outlined-multiline-static"
                                  value={formatNameCapitals(requestClassGrades.toString())}
                                  fontSize="1.1rem"
                                  multiline
                                  size='medium'
                                // rows={4}
...
ResultsSubject.propTypes = {
  requests: PropTypes.array.isRequired,
  onPageParamsChange: PropTypes.func,
  numberOfResults: PropTypes.number,
};

ResultsSubject.defaultProps = {
  requests: [],
  onPageParamsChange: () => { },
  numberOfResults: 55
};
