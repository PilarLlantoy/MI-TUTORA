        ...
        >
          ...
          <ThemeToggleWrapper>
            ...
            <Stack alignItems="center" spacing={2}>
              <Tooltip placement="left" title="Aim Educa" arrow key={1}>
                <ButtonWrapper
                  className={theme === 'AimTheme' ? 'active' : ''}
                  onClick={() => {
                    changeTheme('AimTheme');
                  }}
                >
                  {theme === 'AimTheme' && (
                    <CheckSelected>
                  ...
                  <ColorSchemeWrapper className="colorSchemeWrapper aimTheme">
                    <Box className="primary" />
                    <Box className="secondary" />
                  </ColorSchemeWrapper>
                </ButtonWrapper>
              </Tooltip>
              <Tooltip placement="left" title="Pure Light" arrow key={2}>
                <ButtonWrapper
              ...
              <Tooltip placement="left" title="Grey Goose" arrow key={3}>
                <ButtonWrapper
              ...
              <Tooltip placement="left" title="Purple Flow" arrow key={4}>
                <ButtonWrapper
